...
{
      17,     0,    -1,    18,    -1,     7,    13,    19,    -1,    19,
       9,    19,    -1,    19,    10,    19,    -1,    19,    11,    19,
      -1,    19,    12,    19,    -1,    14,    19,    15,    -1,     7,
      -1,     8,    -1
};
...
{
  "$end", "error", "$undefined", "DELIM", "WS", "LETTER", "DIGIT", "ID",
  "NUMBER", "ADD", "SUB", "MUL", "DIV", "'='", "'('", "')'", "$accept",
  "SS", "S", "expr", 0
};
#endif
...
{
       6,     7,     1,    11,    12,    13,    14,     8,    10,    15,
       4,    16,    17,    18,    19,    11,    12,    13,    14,    13,
      14,     5
};

static const yytype_uint8 yycheck[] =
{
       7,     8,     7,     9,    10,    11,    12,    14,     8,    15,
      13,    11,    12,    13,    14,     9,    10,    11,    12,    11,
      12,     0
};
...
{
       0,     7,    17,    18,    13,     0,     7,     8,    14,    19,
      19,     9,    10,    11,    12,    15,    19,    19,    19,    19
};
...
/* Line 1455 of yacc.c  */
#line 51 "yacc.y"
    { printf("%s = %s;", (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)])); }
    break;
...
/* Line 1455 of yacc.c  */
#line 54 "yacc.y"
    { if (nOpForLastOutput > 1) (yyval) = calculate((yyvsp[(3) - (3)]), '+', (yyvsp[(1) - (3)])); 
									else {(yyval) = malloc(100); sprintf((yyval), "%s + ", (yyvsp[(3) - (3)])); 
									strcat((yyval), (yyvsp[(1) - (3)]));} }
    break;
